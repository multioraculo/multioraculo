...
export const es: Dictionary = {
  ...
  horoscope: {
    ...
    inWord: "en",
    summary: "En resumen",
    summaryRetro: "Retrógrados: {corpos}",
    summaryNoRetro: "Ningún planeta retrógrado hoy.",
    summaryTightest: "El ángulo más exacto de hoy: {texto}",
    summaryLunation: "Fase exacta hoy: {fase}, en {signo}",
    summaryEnters: "{corpo} entra en {signo}",
    summaryStationRetro: "{corpo} se vuelve retrógrado",
    summaryStationDirect: "{corpo} se vuelve directo",
    summaryEclipseSolar: "Eclipse solar en {signo}",
    summaryEclipseLunar: "Eclipse lunar en {signo}",
    sky: "El cielo de hoy",
    skyNote: "Calculado, no interpretado.",
    positions: "Posiciones",
    aspects: "Aspectos",
    events: "Eventos",
    collective: "Fondo colectivo: movimientos de años, no del día.",
    applying: "aplicativo",
    separating: "separativo",
