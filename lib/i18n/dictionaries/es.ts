...
export const es: Dictionary = {
  ...
  nav: {
    ...
    plans: "Planes",
    explorePlans: "Planes y suscripción",
  ...
  home: {
    ...
    skySection: "El cielo de hoy",
    skySameForAll: "El cielo de hoy es el mismo para todos.",
    seeFullSky: "Ver el cielo completo",
    openInMultioraculo: "abrir en Multioráculo",
    pickMySign: "Elegir mi signo",
    seeSignReading: "Ver la lectura completa",
    drawQuestion: "¿Qué está en evidencia hoy?",
    skyToday: "En el cielo hoy",
    evidence: "Lo que este cielo pone en evidencia",
    seeHoroscope: "Ver el horóscopo del día",
    signToday: "{signo} hoy",
    sharedWithSign: "Esta lectura es compartida con todas las personas de {signo}.",
    yourChartDiffers: "En tu carta, ese mismo cielo toca tu Luna, tu Ascendente y tus casas de un modo que es solo tuyo.",
    seeFullReading: "Ver la lectura completa",
    drawCollective: "Tirada colectiva",
    drawPersonal: "Tirada personal",
    andYouToday: "¿Y en ti, qué está en evidencia hoy?",
  ...
  interconexoes: {
    ...
    sameForAll: "El cielo de hoy es el mismo para todos. La forma en que te encuentra es particular.",
    whatItDoes: "Las Interconexiones cruzan el cielo de ahora con tu carta natal para mostrar qué puntos tuyos están siendo activados hoy.",
    natalIs: "Tu carta natal registra la posición del Sol, de la Luna y de los planetas en el momento en que naciste, además del Ascendente y las casas. Funciona como la base fija de esta lectura.",
    skyMoves: "El cielo, sin embargo, sigue en movimiento. Los planetas cambian de posición, forman nuevos aspectos y atraviesan distintas partes del zodíaco. Las Interconexiones observan cómo esos movimientos actuales se relacionan con tu carta natal.",
    examples: [
      "cuando un planeta de hoy forma aspecto con un planeta natal",
      "cuando la Luna actual atraviesa una casa de tu carta",
      "cuando un tránsito toca tu Ascendente",
      "cuando movimientos actuales activan puntos específicos de tu carta",
    ],
    mapStays: "Tu carta natal permanece. Las Interconexiones cambian con el cielo.",
    mapStaysBody: "Por eso la lectura puede cambiar cada día.",
    vsHoroscope: "El horóscopo del signo es una lectura compartida con las demás personas de ese signo. Las Interconexiones miran tu carta entera y muestran cómo el cielo de hoy te encuentra a ti en particular.",
    mapSubtitle: "El cielo de tu nacimiento, la base fija de la lectura.",
    todaySubtitle: "Cómo el cielo actual encuentra esa carta hoy.",
    formTitle: "Para calcular tu carta natal",
    formBody: "Necesitamos ubicar el cielo en el momento y el lugar en que naciste.",
    fieldDate: "Fecha de nacimiento",
    fieldTime: "Hora de nacimiento",
    fieldCity: "Ciudad de nacimiento",
    timeUnknown: "No sé la hora",
    cityPlaceholder: "escribe el nombre de la ciudad",
    citySearching: "buscando",
    cityNone: "Ninguna ciudad con ese nombre.",
    save: "Encontrar mi cielo",
    saving: "Calculando",
    needAccount: "Tu carta queda guardada en tu cuenta.",
    signIn: "Entrar",
    mapTitle: "Tu carta natal",
    mapNote: "Este es el cielo de tu nacimiento. Ya no cambia.",
    asc: "Ascendente",
    mc: "Medio Cielo",
    house: "casa {n}",
    noTimeTitle: "Sin la hora de nacimiento",
    noTimeBody: "Tu carta no tiene Ascendente, Medio Cielo ni casas: los tres dependen de la hora. Si descubres la hora, entra aquí.",
    uncertain: "puede estar entre {a} y {b}",
    ambiguous: "En esa fecha ese horario ocurrió dos veces, al terminar el horario de verano. Usamos el primero.",
    nonexistent: "En esa fecha ese horario no existió: el reloj saltó hacia adelante. Usamos el instante siguiente.",
    todayTitle: "Tus interconexiones de hoy",
    aspectWith: "{transito} de hoy en {aspecto} con tu {ponto}",
    crossing: "{transito} de hoy atraviesa tu {casa} natal",
    natal: "natal",
    realAngle: "ángulo real {angulo}°",
    orb: "orbe {orbe}°",
    applying: "aplicativo",
    ...
    cancel: "Cancelar",
    edit: "Corregir mis datos",
    remove: "Borrar mi carta",
  },
  ...
  hero: {
    ...
    alsoIndividual: "También puedes abrir cada oráculo y leer su interpretación completa.",
  ...
  horoscope: {
    title: "Horóscopo",
    soon: "La carta natal, con casas y aspectos, viene a continuación.",
    intro: "El cielo de hoy, leído signo a signo.",
    chooseSign: "Tu signo",
    loading: "Leyendo el cielo de hoy…",
    focus: "En foco hoy",
    relations: "Relaciones del cielo",
    articulation: "Articulación posible",
    convergence: "En el mismo punto",
    alsoToday: "También hoy",
    inSign: "En {signo}",
    inWord: "en",
    planetsInSky: "Planetas en el cielo",
    mainAspects: "Aspectos principales",
    evidence: "Lo que este cielo pone en evidencia",
    evidenceWaiting: "La lectura de este cielo todavía se está escribiendo.",
    sky: "El cielo de hoy",
    skyNote: "Calculado, no interpretado.",
    positions: "Posiciones",
    aspects: "Aspectos",
    events: "Eventos",
    collectiveTitle: "Fondo colectivo",
    collective: "movimientos de años, no del día",
    applying: "aplicativo",
    separating: "separativo",
    retrograde: "retrógrado",
    orb: "orbe",
    unavailable: "La lectura de hoy aún no está lista. Los movimientos y el cielo calculado quedan aquí abajo.",
    dates: ["21/3 - 19/4", "20/4 - 20/5", "21/5 - 20/6", "21/6 - 22/7", "23/7 - 22/8", "23/8 - 22/9", "23/9 - 22/10", "23/10 - 21/11", "22/11 - 21/12", "22/12 - 19/1", "20/1 - 18/2", "19/2 - 20/3"],
  },
