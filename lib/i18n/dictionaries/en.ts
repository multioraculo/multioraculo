...
export const en: Dictionary = {
  ...
  horoscope: {
    ...
    inWord: "in",
    summary: "In brief",
    summaryRetro: "Retrograde: {corpos}",
    summaryNoRetro: "No planet is retrograde today.",
    summaryTightest: "The tightest angle today: {texto}",
    summaryLunation: "Exact phase today: {fase}, in {signo}",
    summaryEnters: "{corpo} enters {signo}",
    summaryStationRetro: "{corpo} turns retrograde",
    summaryStationDirect: "{corpo} turns direct",
    summaryEclipseSolar: "Solar eclipse in {signo}",
    summaryEclipseLunar: "Lunar eclipse in {signo}",
    sky: "Today's sky",
    skyNote: "Calculated, not interpreted.",
    positions: "Positions",
    aspects: "Aspects",
    events: "Events",
    collective: "Collective background: movements of years, not of the day.",
    applying: "applying",
    separating: "separating",
