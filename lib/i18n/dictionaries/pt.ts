...
export const pt = {
  ...
  faq: {
    items: [
      ...
      },
      {
        ...
        a: "Uma leitura simultânea de Tarô, I Ching, Runas, Búzios e Lenormand com síntese unificada e os cinco oráculos em abas para consulta completa. Inclui um sinal prático para as próximas 24 a 72 horas.",
      },
      {
        q: "Quantas tiragens tenho em cada plano?",
        a: "Essencial: duas por semana, total de 8 por mês.\nIlimitado: tiragens ilimitadas para uso pessoal.",
      },
      {
      ...
      },
      {
        ...
        a: "Suporte por e-mail no Essencial. Suporte prioritário no Ilimitado. O contato aparece dentro do app em Ajuda.",
      },
    ],
  },
  ...
  subscription: {
    ...
    essential: {
      ...
      description: "Duas tiragens por semana (8 por mês), para manter o rumo sem ansiedade.",
      features: [
      ...
      forWhom: "prefere uma pergunta boa por vez, semana após semana.",
    ...
    unlimited: {
      ...
      description: "Tiragens ilimitadas (uso pessoal) para transformar símbolo em gesto, todos os dias.",
      features: [
        "Tudo do Essencial",
