...
export const pt = {
  ...
  horoscope: {
    ...
    summaryNoRetro: "Nenhum planeta retrógrado hoje.",
    summaryTightest: "O ângulo mais exato de hoje: {texto}",
    summaryLunation: "Fase exata hoje: {fase}, em {signo}",
    summaryEnters: "{corpo} entra em {signo}",
    summaryStationRetro: "{corpo} fica retrógrado",
    summaryStationDirect: "{corpo} fica direto",
    summaryEclipseSolar: "Eclipse solar em {signo}",
    summaryEclipseLunar: "Eclipse lunar em {signo}",
    sky: "O céu de hoje",
    skyNote: "Calculado, não interpretado.",
    positions: "Posições",
    aspects: "Aspectos",
    events: "Eventos",
    collective: "Fundo coletivo: movimentos de anos, não do dia.",
    applying: "aplicativo",
    separating: "separativo",
