...
export const pt = {
  ...
  home: {
    ...
    skySection: "O céu de hoje",
    skySameForAll: "O céu de hoje é o mesmo para todos.",
    seeFullSky: "Ver o céu completo",
    openInMultioraculo: "abrir no Multioráculo",
    pickMySign: "Escolher meu signo",
    seeSignReading: "Ver a leitura completa",
    drawQuestion: "O que está em evidência hoje?",
    skyToday: "No céu hoje",
    evidence: "O que este céu coloca em evidência",
    seeHoroscope: "Ver o horóscopo do dia",
    signToday: "{signo} hoje",
    sharedWithSign: "Esta leitura é compartilhada com todas as pessoas de {signo}.",
    yourChartDiffers: "No seu mapa, o mesmo céu toca sua Lua, seu Ascendente e suas casas de um jeito que é só seu.",
    seeFullReading: "Ver leitura completa",
    drawCollective: "Tiragem coletiva",
    drawPersonal: "Tiragem pessoal",
    andYouToday: "E em você, o que está em evidência hoje?",
  ...
  interconexoes: {
    ...
    title: "Interconexões",
    sameForAll: "O céu de hoje é o mesmo para todos. A forma como ele encontra você é particular.",
    whatItDoes: "As Interconexões cruzam o céu de agora com o seu mapa natal para mostrar quais pontos seus estão sendo ativados hoje.",
    natalIs: "Seu mapa natal registra a posição do Sol, da Lua e dos planetas no momento em que você nasceu, além do Ascendente e das casas. Ele funciona como a base fixa dessa leitura.",
    skyMoves: "O céu, porém, continua em movimento. Os planetas mudam de posição, formam novos aspectos e atravessam diferentes partes do zodíaco. As Interconexões observam como esses movimentos atuais se relacionam com o seu mapa natal.",
    examples: [
      "quando um planeta de hoje forma aspecto com um planeta natal",
      "quando a Lua atual atravessa uma casa do seu mapa",
      "quando um trânsito toca seu Ascendente",
      "quando movimentos atuais ativam pontos específicos do seu mapa",
    ],
    mapStays: "Seu mapa natal permanece. As Interconexões mudam com o céu.",
    mapStaysBody: "Por isso, a leitura pode mudar a cada dia.",
    vsHoroscope: "O horóscopo do signo é uma leitura compartilhada com outras pessoas do mesmo signo. As Interconexões olham para o seu mapa inteiro e mostram como o céu de hoje encontra especificamente você.",
    mapSubtitle: "Seu céu de nascimento, a base fixa da leitura.",
    todaySubtitle: "Como o céu atual encontra esse mapa hoje.",
    formTitle: "Para calcular o seu mapa natal",
    formBody: "Precisamos localizar o céu no momento e no lugar em que você nasceu.",
    fieldDate: "Data de nascimento",
    fieldTime: "Hora de nascimento",
    fieldCity: "Cidade de nascimento",
    timeUnknown: "Não sei a hora",
    cityPlaceholder: "escreva o nome da cidade",
    citySearching: "procurando",
    cityNone: "Nenhuma cidade com esse nome.",
    save: "Encontrar meu céu",
    saving: "Calculando",
    needAccount: "Seu mapa fica guardado na sua conta.",
    signIn: "Entrar",
    mapTitle: "Seu mapa natal",
    mapNote: "Este é o céu do seu nascimento. Ele não muda mais.",
    asc: "Ascendente",
    mc: "Meio-do-Céu",
    house: "casa {n}",
    noTimeTitle: "Sem a hora de nascimento",
    noTimeBody: "Seu mapa não tem Ascendente, Meio-do-Céu nem casas: os três dependem da hora. Se você descobrir a hora, ela entra aqui.",
    uncertain: "pode estar entre {a} e {b}",
    ambiguous: "Nessa data esse horário aconteceu duas vezes, na volta do horário de verão. Usamos o primeiro.",
    nonexistent: "Nessa data esse horário não existiu: o relógio pulou para a frente. Usamos o instante seguinte.",
    todayTitle: "Suas interconexões de hoje",
    aspectWith: "{transito} de hoje em {aspecto} com {artigo} {ponto}",
    crossing: "{transito} de hoje atravessa sua {casa} natal",
    natal: "natal",
    realAngle: "ângulo real {angulo}°",
    orb: "orbe {orbe}°",
    applying: "aplicativo",
    ...
    cancel: "Cancelar",
    edit: "Corrigir meus dados",
    remove: "Apagar meu mapa",
  },
  ...
  horoscope: {
    title: "Horóscopo",
    soon: "O mapa astral, com casas e aspectos, vem em seguida.",
    intro: "O céu de hoje, lido signo a signo.",
    chooseSign: "Seu signo",
    loading: "Lendo o céu de hoje…",
    focus: "Em foco hoje",
    relations: "Relações do céu",
    articulation: "Articulação possível",
    convergence: "No mesmo ponto",
    alsoToday: "Também hoje",
    inSign: "Em {signo}",
    inWord: "em",
    planetsInSky: "Planetas no céu",
    mainAspects: "Aspectos principais",
    evidence: "O que este céu coloca em evidência",
    evidenceWaiting: "A leitura deste céu ainda está sendo escrita.",
    sky: "O céu de hoje",
    skyNote: "Calculado, não interpretado.",
    positions: "Posições",
    aspects: "Aspectos",
    events: "Eventos",
    collectiveTitle: "Fundo coletivo",
    collective: "movimentos de anos, não do dia",
    applying: "aplicativo",
    separating: "separativo",
    retrograde: "retrógrado",
    orb: "orbe",
    unavailable: "A leitura de hoje ainda não está pronta. Os movimentos e o céu calculado ficam aqui embaixo.",
